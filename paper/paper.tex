...
making refactoring difficult. In this work, we present a model
for fault-tolerant distributed system verification that combines
...
the model to model-checking various implementations of the
